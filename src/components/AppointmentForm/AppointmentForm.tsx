    ...
    return (
        <div className={styles.container}>
            ...
            <p className={styles.description}>
                ...
                step to creating a safe and comfortable environment for your
                family. Fill out the simple form below to schedule an
                appointment with one of our professional nannies. We guarantee
                confidentiality and high quality service.
            </p>
            ...
            <div className={styles.nannyInfo}>
                ...
                <div className={styles.nannyText}>
                    <span className={styles.label}>Your nanny</span>
                    <span className={styles.name}>{nanny.name}</span>
                </div>
            </div>
